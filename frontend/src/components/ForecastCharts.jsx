          ...
          <div className="h-48 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={hourly} margin={{ top: 8, right: 8, left: -28, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="temp" name="Temperature" stroke="#38bdf8" strokeWidth={2} fillOpacity={1} fill="url(#tempGrad)" />
                <Area type="monotone" dataKey="pop" name="Rain" stroke="#6366f1" strokeWidth={1.5} fillOpacity={1} fill="url(#rainGrad)" strokeDasharray="4 3" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
